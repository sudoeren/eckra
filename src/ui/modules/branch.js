  ...
  const { action } = await prompt([
    {
      ...
      choices: [
        menuItem("New Branch", "success"),
        menuItem("Switch Branch"),
        menuItem("Merge"),
        menuItem("Compare Branches"),
        menuItem("Remote Branches"),
        menuItem("Delete Branch", "danger"),
        sep(),
        backItem(),
      ],
      loop: true,
        ...
        const { remoteAction } = await prompt([
          {
            ...
            choices: [
              menuItem("Checkout (Track)", "success"),
              menuItem("Cancel", "muted"),
            ],
            loop: true,
            pageSize: 15,
          },
